...
const (
	...
	DefaultExternalZoneCacheSeconds    = 30
	...
	DefaultUseNodeResolvConf           = true
	UpstreamForwardingConfigRandom     = "random"
	UpstreamForwardingConfigRoundRobin = "round_robin"
	UpstreamForwardingConfigSequential = "sequential"
