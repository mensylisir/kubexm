...
func (in *HAProxyBackendServer) DeepCopyInto(out *HAProxyBackendServer) {
	*out = *in
	if in.Weight != nil {
...
func (in *HAProxyConfig) DeepCopyInto(out *HAProxyConfig) {
	*out = *in
	if in.FrontendBindAddress != nil {
		in, out := &in.FrontendBindAddress, &out.FrontendBindAddress
		*out = new(string)
		**out = *in
	}
	...
	if in.BackendServers != nil {
		...
		*out = make([]HAProxyBackendServer, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ExtraGlobalConfig != nil {
		in, out := &in.ExtraGlobalConfig, &out.ExtraGlobalConfig
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExtraDefaultsConfig != nil {
		in, out := &in.ExtraDefaultsConfig, &out.ExtraDefaultsConfig
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExtraFrontendConfig != nil {
		in, out := &in.ExtraFrontendConfig, &out.ExtraFrontendConfig
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.ExtraBackendConfig != nil {
		in, out := &in.ExtraBackendConfig, &out.ExtraBackendConfig
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HAProxyBackendServer.
func (in *HAProxyBackendServer) DeepCopy() *HAProxyBackendServer {
	if in == nil {
		return nil
	}
	out := new(HAProxyBackendServer)
	in.DeepCopyInto(out)
	return out
}
