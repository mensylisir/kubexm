...
func (in *KubeVIPBGPConfig) DeepCopyInto(out *KubeVIPBGPConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeVIPBGPConfig.
func (in *KubeVIPBGPConfig) DeepCopy() *KubeVIPBGPConfig {
	if in == nil {
		return nil
	}
	out := new(KubeVIPBGPConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *KubeVIPConfig) DeepCopyInto(out *KubeVIPConfig) {
	*out = *in
	...
	if in.EnableControlPlaneLB != nil {
		in, out := &in.EnableControlPlaneLB, &out.EnableControlPlaneLB
		*out = new(bool)
		**out = *in
	}
	if in.EnableServicesLB != nil {
		in, out := &in.EnableServicesLB, &out.EnableServicesLB
		*out = new(bool)
		**out = *in
	}
	if in.Image != nil {
