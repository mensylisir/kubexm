...
type Kubernetes struct {
	...
	MaxPods                *int     `json:"maxPods,omitempty" yaml:"maxPods,omitempty"`                   // Default 110
	NodeCidrMaskSize       *int     `json:"nodeCidrMaskSize,omitempty" yaml:"nodeCidrMaskSize,omitempty"` // Default 24
	NodeCidrMaskSizeIPv6   *int     `yaml:"nodeCidrMaskSizeIPv6,omitempty" json:"nodeCidrMaskSizeIPv6,omitempty"`
	...
	NodeFeatureDiscovery   *NodeFeatureDiscovery  `json:"nodeFeatureDiscovery,omitempty" yaml:"nodeFeatureDiscovery,omitempty"`
	Kata                   *Kata                  `json:"kata,omitempty" yaml:"kata,omitempty"`
	ApiServerArgs          *APIServerArgs         `json:"apiServerArgs,omitempty" yaml:"apiServerArgs,omitempty"`
	ControllerManagerArgs  *ControllerManagerArgs `json:"controllerManagerArgs,omitempty" yaml:"controllerManagerArgs,omitempty"`
	SchedulerArgs          *SchedulerArgs         `json:"schedulerArgs,omitempty" yaml:"schedulerArgs,omitempty"`
	KubeletArgs            *KubeletArgs           `json:"kubeletArgs,omitempty" yaml:"kubeletArgs,omitempty"`
	KubeProxyArgs          *KubeProxyArgs         `json:"kubeProxyArgs,omitempty" yaml:"kubeProxyArgs,omitempty"`
	...
	NvidiaRuntime          *bool                  `yaml:"nvidiaRuntime,omitempty" json:"nvidiaRuntime,omitempty"`
}
...
func SetDefaults_KubernetesConfig(cfg *KubernetesConfig, clusterMetaName string) {
	...
	if cfg.AutoRenewCerts == nil {
		b := true
		cfg.AutoRenewCerts = &b
	}
	if cfg.DisableKubeProxy == nil {
		b := false
		cfg.DisableKubeProxy = &b
	}
	...
	if cfg.Nodelocaldns == nil {
		cfg.Nodelocaldns = &NodelocaldnsConfig{}
	}
	if cfg.Nodelocaldns.Enabled == nil {
		b := true
		cfg.Nodelocaldns.Enabled = &b
	}
	...
	if cfg.Kata.Enabled == nil {
		b := false
		cfg.Kata.Enabled = &b
	}

	if cfg.NodeFeatureDiscovery == nil {
		cfg.NodeFeatureDiscovery = &NodeFeatureDiscoveryConfig{}
	}
	if cfg.NodeFeatureDiscovery.Enabled == nil {
		b := false
		cfg.NodeFeatureDiscovery.Enabled = &b
	}
	...
	if cfg.APIServer.ExtraArgs == nil {
		cfg.APIServer.ExtraArgs = []string{}
	}
	if cfg.APIServer.AdmissionPlugins == nil {
		cfg.APIServer.AdmissionPlugins = []string{}
	}
	...
	if cfg.ControllerManager.ExtraArgs == nil {
		cfg.ControllerManager.ExtraArgs = []string{}
	}
	...
	if cfg.Scheduler.ExtraArgs == nil {
		cfg.Scheduler.ExtraArgs = []string{}
	}
	...
	if cfg.KubeProxy.ExtraArgs == nil {
		cfg.KubeProxy.ExtraArgs = []string{}
	}
	...
	if cfg.KubeProxy.IPTables != nil {
		if cfg.KubeProxy.IPTables.MasqueradeAll == nil {
			b := true
			cfg.KubeProxy.IPTables.MasqueradeAll = &b
		}
		if cfg.KubeProxy.IPTables.MasqueradeBit == nil {
			mb := int32(14)
			cfg.KubeProxy.IPTables.MasqueradeBit = &mb
		}
	}
	...
	if cfg.KubeProxy.IPVS != nil {
		if cfg.KubeProxy.IPVS.Scheduler == "" {
			sched := "rr"
			cfg.KubeProxy.IPVS.Scheduler = sched
		}
		if cfg.KubeProxy.IPVS.ExcludeCIDRs == nil {
			cfg.KubeProxy.IPVS.ExcludeCIDRs = []string{}
		}
	}
}
...
func SetDefaults_KubeletConfig(cfg *KubeletConfig, parentContainerManager string) {
	...
	if cfg.EvictionHard == nil {
		cfg.EvictionHard = make(map[string]string)
	}
...
func Validate_KubernetesConfig(cfg *KubernetesConfig, verrs *ValidationErrors, pathPrefix string) {
	...
	if cfg.APIServer != nil {
		Validate_APIServerConfig(cfg.APIServer, verrs, pathPrefix+".apiServer")
	}
	if cfg.ControllerManager != nil {
		Validate_ControllerManagerConfig(cfg.ControllerManager, verrs, pathPrefix+".controllerManager")
	}
	if cfg.Scheduler != nil {
		Validate_SchedulerConfig(cfg.Scheduler, verrs, pathPrefix+".scheduler")
	}
	if cfg.Kubelet != nil {
		Validate_KubeletConfig(cfg.Kubelet, verrs, pathPrefix+".kubelet")
	}
	if cfg.KubeProxy != nil {
		Validate_KubeProxyConfig(cfg.KubeProxy, verrs, pathPrefix+".kubeProxy", cfg.ProxyMode)
	}
