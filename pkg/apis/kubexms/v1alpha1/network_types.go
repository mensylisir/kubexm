	...
	*out = *in
	...
	if in.Cilium != nil {
		...
		*out = new(CiliumConfig)
		(*in).DeepCopyInto(*out) // Assumes CiliumConfig has DeepCopyInto in cilium_types.go
	}
	if in.Flannel != nil {
	...
	if in.Hybridnet != nil {
		in, out := &in.Hybridnet, &out.Hybridnet
		*out = new(HybridnetConfig)
		(*in).DeepCopyInto(*out)
	}
	if in.IPPool != nil {
...
func (in *CalicoConfig) DeepCopyInto(out *CalicoConfig) {
	*out = *in
	...
	if in.IPv4NatOutgoing != nil {
		in, out := &in.IPv4NatOutgoing, &out.IPv4NatOutgoing
		*out = new(bool)
		**out = *in
	}
	if in.DefaultIPPOOL != nil {
		in, out := &in.DefaultIPPOOL, &out.DefaultIPPOOL
		*out = new(bool)
		**out = *in
	}
	if in.EnableTypha != nil {
		in, out := &in.EnableTypha, &out.EnableTypha
		*out = new(bool)
		**out = *in
	}
	...
	if in.LogSeverityScreen != nil {
		in, out := &in.LogSeverityScreen, &out.LogSeverityScreen
		*out = new(string)
		**out = *in
	}
	if in.IPPools != nil {
...
func (in *FlannelConfig) DeepCopyInto(out *FlannelConfig) {
	*out = *in
	if in.DirectRouting != nil {
		in, out := &in.DirectRouting, &out.DirectRouting
		*out = new(bool)
		**out = *in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeOvnConfig) DeepCopyInto(out *KubeOvnConfig) {
	*out = *in
	if in.Enabled != nil {
	...
	if in.JoinCIDR != nil {
		in, out := &in.JoinCIDR, &out.JoinCIDR
		*out = new(string)
		**out = *in
	}
	if in.Label != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeOvnConfig.
func (in *KubeOvnConfig) DeepCopy() *KubeOvnConfig {
	if in == nil {
		return nil
	}
	out := new(KubeOvnConfig)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HybridnetConfig) DeepCopyInto(out *HybridnetConfig) {
	*out = *in
	if in.Enabled != nil {
		in, out := &in.Enabled, &out.Enabled
		*out = new(bool)
	...
	if in.DefaultNetworkType != nil {
		in, out := &in.DefaultNetworkType, &out.DefaultNetworkType
		*out = new(string)
		**out = *in
	}
	...
	if in.InitDefaultNetwork != nil {
		in, out := &in.InitDefaultNetwork, &out.InitDefaultNetwork
		*out = new(bool)
		**out = *in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HybridnetConfig.
func (in *HybridnetConfig) DeepCopy() *HybridnetConfig {
	if in == nil {
		return nil
	}
	out := new(HybridnetConfig)
...
// SetDefaults_CiliumConfig sets default values for CiliumConfig.
func SetDefaults_CiliumConfig(cfg *CiliumConfig) {
	if cfg == nil {
		return
	}
	if cfg.TunnelingMode == "" {
		cfg.TunnelingMode = "vxlan" // Default as per doc
	}
	if cfg.KubeProxyReplacement == "" {
		cfg.KubeProxyReplacement = "strict" // Default as per doc
	}
	// EnableHubble defaults to false (zero-value for bool)
	// HubbleUI defaults to false (zero-value for bool)
	if cfg.EnableBPFMasquerade == nil {
		cfg.EnableBPFMasquerade = util.BoolPtr(true) // Default to true
	}
	if cfg.IdentityAllocationMode == "" {
		cfg.IdentityAllocationMode = "crd" // Default as per doc
	}
}
...
func Validate_CiliumConfig(cfg *CiliumConfig, verrs *validation.ValidationErrors, pathPrefix string) {
	...
	if !util.ContainsString(validCiliumTunnelModes, cfg.TunnelingMode) {
		verrs.Add(pathPrefix+".tunnelingMode", fmt.Sprintf("invalid tunnelingMode '%s', must be one of %v", cfg.TunnelingMode, validCiliumTunnelModes))
	}
	if !util.ContainsString(validCiliumKPRModes, cfg.KubeProxyReplacement) {
		verrs.Add(pathPrefix+".kubeProxyReplacement", fmt.Sprintf("invalid kubeProxyReplacement mode '%s', must be one of %v", cfg.KubeProxyReplacement, validCiliumKPRModes))
	}
	if !util.ContainsString(validCiliumIdentModes, cfg.IdentityAllocationMode) {
		verrs.Add(pathPrefix+".identityAllocationMode", fmt.Sprintf("invalid identityAllocationMode '%s', must be one of %v", cfg.IdentityAllocationMode, validCiliumIdentModes))
	}
	if cfg.HubbleUI && !cfg.EnableHubble {
		verrs.Add(pathPrefix+".hubbleUI", "cannot be true if enableHubble is false")
	}
	// EnableBPFMasquerade is a *bool, so its presence and value are valid.
}
