...
func (in *EtcdConfig) DeepCopyInto(out *EtcdConfig) {
	*out = *in
	...
	if in.BackupDir != nil {
		in, out := &in.BackupDir, &out.BackupDir
		*out = new(string)
		**out = *in
	}
	if in.BackupPeriodHours != nil {
		in, out := &in.BackupPeriodHours, &out.BackupPeriodHours
		*out = new(int)
		**out = *in
	}
	if in.KeepBackupNumber != nil {
		in, out := &in.KeepBackupNumber, &out.KeepBackupNumber
		*out = new(int)
		**out = *in
	}
	if in.BackupScriptPath != nil {
		in, out := &in.BackupScriptPath, &out.BackupScriptPath
		*out = new(string)
		**out = *in
	}
	if in.HeartbeatIntervalMillis != nil {
		in, out := &in.HeartbeatIntervalMillis, &out.HeartbeatIntervalMillis
		*out = new(int)
		**out = *in
	}
	if in.ElectionTimeoutMillis != nil {
		in, out := &in.ElectionTimeoutMillis, &out.ElectionTimeoutMillis
		*out = new(int)
		**out = *in
	}
	...
	if in.AutoCompactionRetentionHours != nil {
		in, out := &in.AutoCompactionRetentionHours, &out.AutoCompactionRetentionHours
		*out = new(int)
		**out = *in
	}
	...
	if in.MaxSnapshotsToKeep != nil {
		in, out := &in.MaxSnapshotsToKeep, &out.MaxSnapshotsToKeep
		*out = new(uint)
		**out = *in
	}
	if in.MaxWALsToKeep != nil {
		in, out := &in.MaxWALsToKeep, &out.MaxWALsToKeep
		*out = new(uint)
		**out = *in
	}
}
