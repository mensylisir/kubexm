...
func NewCheckClusterHealthStepBuilder(ctx runtime.Context, instanceName string) *CheckClusterHealthStepBuilder {
...
func (s *CheckClusterHealthStep) Run(ctx runtime.ExecutionContext) error {
