...
func NewInstallKubeadmStepBuilder(ctx runtime.Context, instanceName string) *InstallKubeadmStepBuilder {
...
func (s *InstallKubeadmStep) Run(ctx runtime.ExecutionContext) error {
	...
	remoteUploadTmpDir := filepath.Join(common.DefaultUploadTmpDir, fmt.Sprintf("kubeadm-%d", time.Now().UnixNano()))
