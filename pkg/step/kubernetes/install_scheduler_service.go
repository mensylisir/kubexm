...
const (
	KubeSchedulerServiceTemplatePath = "kubernetes/kube-scheduler.service.tmpl"
)
...
func (b *InstallKubeSchedulerServiceStepBuilder) WithTargetPath(path string) *InstallKubeSchedulerServiceStepBuilder {
	b.Step.TargetPath = path
	return b
}

func (b *InstallKubeSchedulerServiceStepBuilder) WithKubeSchedulerExecStartPath(path string) *InstallKubeSchedulerServiceStepBuilder {
...
func (s *InstallKubeSchedulerServiceStep) renderContent(ctx runtime.ExecutionContext) (string, error) {
