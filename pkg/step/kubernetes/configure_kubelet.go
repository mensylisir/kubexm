...
type ConfigureKubeletStepBuilder struct {
	step.Builder[ConfigureKubeletStepBuilder, *ConfigureKubeletStep]
}
...
func (s *ConfigureKubeletStep) Precheck(ctx runtime.ExecutionContext) (isDone bool, err error) {
...
func (s *ConfigureKubeletStep) Run(ctx runtime.ExecutionContext) error {
...
func (s *ConfigureKubeletStep) Rollback(ctx runtime.ExecutionContext) error {
