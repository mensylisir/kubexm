...
func NewStartKubeProxyStepBuilder(ctx runtime.Context, instanceName string) *StartKubeProxyStepBuilder {
...
func (s *StartKubeProxyStep) Run(ctx runtime.ExecutionContext) error {
