...
func NewEnableKubeProxyStepBuilder(ctx runtime.Context, instanceName string) *EnableKubeProxyStepBuilder {
...
func (s *EnableKubeProxyStep) Run(ctx runtime.ExecutionContext) error {
