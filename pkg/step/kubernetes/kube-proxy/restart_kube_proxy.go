...
func NewRestartKubeProxyStepBuilder(ctx runtime.Context, instanceName string) *RestartKubeProxyStepBuilder {
...
func (s *RestartKubeProxyStep) Run(ctx runtime.ExecutionContext) error {
