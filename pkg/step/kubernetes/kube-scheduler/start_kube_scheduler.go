...
func NewStartKubeSchedulerStepBuilder(ctx runtime.Context, instanceName string) *StartKubeSchedulerStepBuilder {
...
func (s *StartKubeSchedulerStep) Run(ctx runtime.ExecutionContext) error {
