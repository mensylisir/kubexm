...
func GetImage(context runtime.Context, name string) util.Image {
	...
	ImageList := map[string]util.Image{
		...
		"provisioner-localpv":       {RepoAddr: privateRegistry, Namespace: "openebs", Repo: "provisioner-localpv", Tag: "3.3.0", Group: common.RoleWorker, Enable: false},
		"linux-utils":               {RepoAddr: privateRegistry, Namespace: "openebs", Repo: "linux-utils", Tag: "3.3.0", Group: common.RoleWorker, Enable: false},
		...
		"nfs-plugin":                {RepoAddr: privateRegistry, Namespace: "sig-storage", Repo: "nfs-plugin", Tag: "3.3.0", Group: common.RoleWorker, Enable: false},
		"csi-provisioner":           {RepoAddr: privateRegistry, Namespace: "sig-storage", Repo: "csi-provisioner", Tag: "v4.6.0", Group: common.RoleWorker, Enable: false},
		"csi-node-driver-registrar": {RepoAddr: privateRegistry, Namespace: "sig-storage", Repo: "csi-node-driver-registrar", Tag: "v2.10.0", Group: common.RoleWorker, Enable: false},
		"csi-resizer":               {RepoAddr: privateRegistry, Namespace: "sig-storage", Repo: "csi-resizer", Tag: "v1.10.0", Group: common.RoleWorker, Enable: false},
		"csi-snapshotter":           {RepoAddr: privateRegistry, Namespace: "sig-storage", Repo: "csi-snapshotter", Tag: "v7.0.1", Group: common.RoleWorker, Enable: false},
	}
