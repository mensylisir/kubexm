...
func NewCleanNFSProvisionerStepBuilder(ctx runtime.Context, instanceName string) *CleanNFSProvisionerStepBuilder {
...
func (s *CleanNFSProvisionerStep) Run(ctx runtime.ExecutionContext) error {
