...
func NewKubeadmPrepareCAAssetsStepBuilder(ctx runtime.Context, instanceName string) *KubeadmPrepareCAAssetsStepBuilder {
...
func (s *KubeadmPrepareCAAssetsStep) Run(ctx runtime.ExecutionContext) error {
