...
func NewKubeadmDistributeLeafCertsStepBuilder(ctx runtime.Context, instanceName string) *KubeadmDistributeLeafCertsStepBuilder {
...
func (s *KubeadmDistributeLeafCertsStep) Run(ctx runtime.ExecutionContext) error {
