...
func NewKubeadmCheckLeafCertsExpirationStepBuilder(ctx runtime.Context, instanceName string) *KubeadmCheckLeafCertsExpirationStepBuilder {
	certsToCheck := []string{
		"apiserver.crt",
...
func (s *KubeadmCheckLeafCertsExpirationStep) Run(ctx runtime.ExecutionContext) error {
