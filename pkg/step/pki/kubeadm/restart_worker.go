...
func NewKubeadmRestartKubeletStepBuilder(ctx runtime.Context, instanceName string) *KubeadmRestartKubeletStepBuilder {
...
func (s *KubeadmRestartKubeletStep) Run(ctx runtime.ExecutionContext) error {
