...
func NewKubeadmMoveNewAssetsStepBuilder(ctx runtime.Context, instanceName string) *KubeadmMoveNewAssetsStepBuilder {
...
func (s *KubeadmMoveNewAssetsStep) Run(ctx runtime.ExecutionContext) error {
