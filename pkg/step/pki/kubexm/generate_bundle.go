...
func NewKubexmPrepareCATransitionStepBuilder(ctx runtime.Context, instanceName string) *KubexmPrepareCATransitionStepBuilder {
...
func (s *KubexmPrepareCATransitionStep) Run(ctx runtime.ExecutionContext) error {
