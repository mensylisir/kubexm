...
func NewKubexmRenewK8sCAStepBuilder(ctx runtime.Context, instanceName string) *KubexmRenewK8sCAStepBuilder {
...
func (s *KubexmRenewK8sCAStep) Run(ctx runtime.ExecutionContext) error {
