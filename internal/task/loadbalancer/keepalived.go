...
import (
	...
	"github.com/mensylisir/kubexm/internal/step/loadbalancer/haproxy"
	lbpkg "github.com/mensylisir/kubexm/internal/step/loadbalancer/keepalived"
	kubevippkg "github.com/mensylisir/kubexm/internal/step/loadbalancer/kube-vip"
...
func (t *InstallKeepalivedTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	installPkg, err := lbpkg.NewInstallKeepalivedStepBuilder(execCtx, "InstallKeepalivedPackage").Build()
	if err != nil {
		return nil, err
	}
	generateCfg, err := lbpkg.NewGenerateKeepalivedConfigStepBuilder(execCtx, "GenerateKeepalivedConfig").Build()
	if err != nil {
		return nil, err
	}
	deployCfg, err := lbpkg.NewDeployKeepalivedConfigStepBuilder(execCtx, "DeployKeepalivedConfig").Build()
	if err != nil {
		return nil, err
	}
	enableSvc, err := lbpkg.NewEnableKeepalivedStepBuilder(execCtx, "EnableKeepalivedService").Build()
	if err != nil {
		return nil, err
	}
	startSvc, err := lbpkg.NewStartKeepalivedStepBuilder(execCtx, "StartKeepalivedService").Build()
	if err != nil {
		return nil, err
	}
...
func (t *UninstallKeepalivedTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	stopSvc, err := lbpkg.NewStopKeepalivedStepBuilder(execCtx, "StopKeepalivedService").Build()
	if err != nil {
		return nil, err
	}
	disableSvc, err := lbpkg.NewDisableKeepalivedStepBuilder(execCtx, "DisableKeepalivedService").Build()
	if err != nil {
		return nil, err
	}
	removePkg, err := lbpkg.NewRemoveKeepalivedStepBuilder(execCtx, "RemoveKeepalivedPackage").Build()
	if err != nil {
		return nil, err
	}
	removeCfg, err := lbpkg.NewRemoveKeepalivedConfigStepBuilder(execCtx, "RemoveKeepalivedConfig").Build()
	if err != nil {
		return nil, err
	}
...
func (t *InstallHAProxyAsDaemonTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	installHAProxy, err := haproxy.NewInstallHAProxyStepBuilder(execCtx, "InstallHAProxy").Build()
	if err != nil {
		return nil, err
	}
	generateHAProxyConfig, err := haproxy.NewGenerateHAProxyConfigStepBuilder(execCtx, "GenerateHAProxyConfig").Build()
	if err != nil {
		return nil, err
	}
	enableHAProxy, err := haproxy.NewEnableHAProxyStepBuilder(execCtx, "EnableHAProxyService").Build()
	if err != nil {
		return nil, err
	}
	startHAProxy, err := haproxy.NewStartHAProxyStepBuilder(execCtx, "StartHAProxyService").Build()
	if err != nil {
		return nil, err
	}
...
func (t *UninstallHAProxyAsDaemonTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	stopHAProxy, err := haproxy.NewStopHAProxyStepBuilder(execCtx, "StopHAProxyService").Build()
	if err != nil {
		return nil, err
	}
	disableHAProxy, err := haproxy.NewDisableHAProxyStepBuilder(execCtx, "DisableHAProxyService").Build()
	if err != nil {
		return nil, err
	}
	cleanHAProxy, err := haproxy.NewCleanHAProxyStepBuilder(execCtx, "CleanHAProxy").Build()
	if err != nil {
		return nil, err
	}
...
func (t *DeployKubeVIPTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	generateKubeVIP, err := kubevippkg.NewGenerateKubeVipManifestStepBuilder(execCtx, "GenerateKubeVIPManifest").Build()
	if err != nil {
		return nil, err
	}
...
func (t *CleanupKubeVIPTask) Plan(ctx runtime.TaskContext) (*plan.ExecutionFragment, error) {
	...
	cleanKubeVIP, err := kubevippkg.NewCleanKubeVipManifestStepBuilder(execCtx, "CleanKubeVIPManifest").Build()
	if err != nil {
		return nil, err
	}
