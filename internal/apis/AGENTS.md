...
## OVERVIEW
internal/apis contains CRD (Custom Resource Definition) types and API specifications for kubexm cluster configuration. These types define the schema for cluster manifests, including hosts, roles, networking, container runtimes, Kubernetes components, and add-ons.
