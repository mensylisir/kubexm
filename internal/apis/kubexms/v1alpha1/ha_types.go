...
func SetDefaults_HighAvailabilityConfig(cfg *HighAvailability) {
	...
	if cfg.External != nil && cfg.Internal != nil &&
		cfg.External.Enabled != nil && cfg.Internal.Enabled != nil &&
		*cfg.External.Enabled && *cfg.Internal.Enabled {
...
func Validate_ExternalLoadBalancerConfig(cfg *ExternalLoadBalancerConfig, verrs *validation.ValidationErrors, pathPrefix string) {
	...
	validTypes := []string{
		string(common.ExternalLBTypeKubexmKH),
		string(common.ExternalLBTypeKubexmKN),
		string(common.ExternalLBTypeKubeVIP),
		string(common.ExternalLBTypeExternal),
	}
	...
	if cfg.Type != string(common.ExternalLBTypeExternal) {
		if cfg.LoadBalancerHostGroupName == nil || !helpers.IsValidNonEmptyString(*cfg.LoadBalancerHostGroupName) {
