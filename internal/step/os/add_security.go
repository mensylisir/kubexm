...
func (s *ConfigureSecurityLimitsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	if err != nil {
		result.MarkFailed(err, "failed to write security limits config file '%s'"); return result, err
	}
