...
func NewDistributeLonghornArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeLonghornArtifactsStepBuilder {
...
func (s *DistributeLonghornArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Longhorn artifacts distributed successfully")
	return result, nil
}
