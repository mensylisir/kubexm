...
func NewCleanLonghornStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanLonghornStepBuilder {
	s := &CleanLonghornStep{
...
func (s *CleanLonghornStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Longhorn cleanup completed successfully")
	return result, nil
}
