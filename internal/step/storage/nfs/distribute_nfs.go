...
func NewDistributeNFSProvisionerArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeNFSProvisionerArtifactsStepBuilder {
...
func (s *DistributeNFSProvisionerArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("NFS Provisioner artifacts distributed successfully")
	return result, nil
}
