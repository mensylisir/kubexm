...
func NewCleanOpenEBSStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanOpenEBSStepBuilder {
...
func (s *CleanOpenEBSStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("OpenEBS Helm chart uninstalled successfully")
	return result, nil
}
