...
func NewInstallCoreDNSStepBuilder(ctx runtime.ExecutionContext, instanceName string) *InstallCoreDNSStepBuilder {
...
func (s *InstallCoreDNSStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
