...
func NewInstallNodeLocalDNSStepBuilder(ctx runtime.ExecutionContext, instanceName string) *InstallNodeLocalDNSStepBuilder {
...
func (s *InstallNodeLocalDNSStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
