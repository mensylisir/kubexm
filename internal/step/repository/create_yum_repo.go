...
func NewCreateYumRepoStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CreateYumRepoStepBuilder {
	s := &CreateYumRepoStep{}
...
func (s *CreateYumRepoStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	if s.RepoDir == "" {
		err := errors.New("RepoDir must be specified for CreateYumRepoStep")
