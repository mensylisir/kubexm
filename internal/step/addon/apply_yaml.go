...
import (
	...
	"github.com/mensylisir/kubexm/internal/apis/kubexms/v1alpha1" // 严格使用 v1alpha1
...
func NewApplyAddonYamlStepBuilder(ctx runtime.ExecutionContext, addonName string, sourceIndex int) *ApplyAddonYamlStepBuilder {
...
func (s *ApplyAddonYamlStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("all yaml manifests applied successfully")
	return result, nil
}
