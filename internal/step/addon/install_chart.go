...
func NewInstallAddonChartStepBuilder(ctx runtime.ExecutionContext, addonName string, sourceIndex int) *InstallAddonChartStepBuilder {
...
func (s *InstallAddonChartStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
