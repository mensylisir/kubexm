...
func NewInstallArgoCDHelmChartStepBuilder(ctx runtime.ExecutionContext, instanceName string) *InstallArgoCDHelmChartStepBuilder {
...
func (s *InstallArgoCDHelmChartStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
