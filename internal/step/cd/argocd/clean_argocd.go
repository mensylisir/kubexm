...
func NewCleanArgoCDStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanArgoCDStepBuilder {
...
func (s *CleanArgoCDStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Argo CD Helm chart uninstalled successfully")
	return result, nil
}
