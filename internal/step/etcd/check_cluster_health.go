...
func NewEtcdVerifyClusterHealthStepBuilder(ctx runtime.ExecutionContext, instanceName string) *EtcdVerifyClusterHealthStepBuilder {
...
func (s *EtcdVerifyClusterHealthStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
