...
func NewSetupEtcdDirsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *SetupEtcdDirsStepBuilder {
	s := &SetupEtcdDirsStep{
...
func (s *SetupEtcdDirsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Directories setup completed")
	return result, nil
}
