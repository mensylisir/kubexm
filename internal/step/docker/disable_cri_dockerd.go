...
func NewDisableCriDockerdStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DisableCriDockerdStepBuilder {
...
func (s *DisableCriDockerdStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("cri-dockerd service disabled successfully")
	return result, nil
}
