...
func NewGenerateCertsPEMStepBuilder(ctx runtime.ExecutionContext, instanceName string) *GenerateCertsPEMStepBuilder {
...
func (s *GenerateCertsPEMStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("PEM certificate generated successfully")
	return result, nil
}
