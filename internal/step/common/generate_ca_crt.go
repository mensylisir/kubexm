...
func NewGenerateCAStepBuilder(ctx runtime.ExecutionContext, instanceName string) *GenerateCAStepBuilder {
	s := &GenerateCAStep{
...
func (s *GenerateCAStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("CA certificate generated successfully")
	return result, nil
}
