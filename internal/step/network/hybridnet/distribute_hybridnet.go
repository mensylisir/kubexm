...
func NewDistributeHybridnetArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeHybridnetArtifactsStepBuilder {
...
func (s *DistributeHybridnetArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Hybridnet artifacts distributed successfully")
	return result, nil
}
