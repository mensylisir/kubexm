...
func NewDistributeMultusArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeMultusArtifactsStepBuilder {
...
func (s *DistributeMultusArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Multus artifacts distributed successfully")
	return result, nil
}
