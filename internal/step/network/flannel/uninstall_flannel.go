...
func NewUninstallFlannelHelmChartStepBuilder(ctx runtime.ExecutionContext, instanceName string) *UninstallFlannelHelmChartStepBuilder {
...
func (s *UninstallFlannelHelmChartStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Flannel Helm release uninstalled successfully")
	return result, nil
}
