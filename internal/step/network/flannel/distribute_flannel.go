...
func NewDistributeFlannelArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeFlannelArtifactsStepBuilder {
...
func (s *DistributeFlannelArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Flannel artifacts distributed successfully")
	return result, nil
}
