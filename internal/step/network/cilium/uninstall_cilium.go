...
func NewUninstallCiliumHelmChartStepBuilder(ctx runtime.ExecutionContext, instanceName string) *UninstallCiliumHelmChartStepBuilder {
...
func (s *UninstallCiliumHelmChartStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Cilium uninstalled successfully")
	return result, nil
}
