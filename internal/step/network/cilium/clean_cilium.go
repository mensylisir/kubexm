...
func NewCleanCiliumNodeStateStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanCiliumNodeStateStepBuilder {
...
func (s *CleanCiliumNodeStateStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
...
`
	...
	result.MarkCompleted("Cilium node state cleaned up successfully")
	return result, nil
}
