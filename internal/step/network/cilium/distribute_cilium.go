...
func NewDistributeCiliumArtifactsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DistributeCiliumArtifactsStepBuilder {
...
func (s *DistributeCiliumArtifactsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Cilium artifacts distributed successfully")
	return result, nil
}
