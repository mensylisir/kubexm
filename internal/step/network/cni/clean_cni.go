...
func NewCleanCNIStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanCNIStepBuilder {
	s := &CleanCNIStep{}
...
func (s *CleanCNIStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("CNI directories cleaned successfully")
	return result, nil
}
