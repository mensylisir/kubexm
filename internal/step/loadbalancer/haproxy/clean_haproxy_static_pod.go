...
func NewCleanHAProxyStaticPodStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanHAProxyStaticPodStepBuilder {
...
func (s *CleanHAProxyStaticPodStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("HAProxy static pod resources cleaned up successfully")
	return result, nil
}
