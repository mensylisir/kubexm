...
func NewCheckLeafCertsExpirationStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CheckLeafCertsExpirationStepBuilder {
...
func (s *CheckLeafCertsExpirationStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
