...
func NewCleanupTransitionAssetsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanupTransitionAssetsStepBuilder {
...
func (s *CleanupTransitionAssetsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("transition assets cleaned up successfully")
	return result, nil
}
