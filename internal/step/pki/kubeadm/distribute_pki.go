...
func NewKubeadmDistributeK8sPKIStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmDistributeK8sPKIStepBuilder {
...
func (s *KubeadmDistributeK8sPKIStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("K8s PKI files distributed successfully")
	return result, nil
}
