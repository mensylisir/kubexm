...
func NewKubeadmLocalCleanupStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmLocalCleanupStepBuilder {
...
func (s *KubeadmLocalCleanupStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("local workspace cleanup completed")
	return result, nil
}
