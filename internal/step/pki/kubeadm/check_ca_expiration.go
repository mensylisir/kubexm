...
func NewKubeadmCheckK8sCAExpirationStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmCheckK8sCAExpirationStepBuilder {
...
func (s *KubeadmCheckK8sCAExpirationStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
