...
func NewKubeadmRenewK8sCAStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmRenewK8sCAStepBuilder {
...
func (s *KubeadmRenewK8sCAStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("K8s CA certificates renewed successfully")
	return result, nil
}
