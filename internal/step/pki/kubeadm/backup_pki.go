...
func NewKubeadmBackupRemotePKIStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmBackupRemotePKIStepBuilder {
...
func (s *KubeadmBackupRemotePKIStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
