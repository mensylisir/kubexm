...
func NewKubexmPrepareCAAssetsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubexmPrepareCAAssetsStepBuilder {
...
func (s *KubexmPrepareCAAssetsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
