...
type KubexmPrepareCATransitionStep struct {
	step.Base
...
type KubexmPrepareCATransitionStepBuilder struct {
	step.Builder[KubexmPrepareCATransitionStepBuilder, *KubexmPrepareCATransitionStep]
}

func NewKubexmPrepareCATransitionStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubexmPrepareCATransitionStepBuilder {
	...
	s := &KubexmPrepareCATransitionStep{
	...
	b := new(KubexmPrepareCATransitionStepBuilder).Init(s)
	return b
}

func (s *KubexmPrepareCATransitionStep) Meta() *spec.StepMeta {
	return &s.Base.Meta
}

func (s *KubexmPrepareCATransitionStep) Precheck(ctx runtime.ExecutionContext) (isDone bool, err error) {
...
func (s *KubexmPrepareCATransitionStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
...
func (s *KubexmPrepareCATransitionStep) Rollback(ctx runtime.ExecutionContext) error {
...
var _ step.Step = (*KubexmPrepareCATransitionStep)(nil)
