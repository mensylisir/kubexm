...
func NewKubexmCheckLeafCertsExpirationStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubexmCheckLeafCertsExpirationStepBuilder {
	certsToCheck := []string{
		"apiserver.crt",
...
func (s *KubexmCheckLeafCertsExpirationStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("leaf certs expiration check completed")
	return result, nil
}
