...
func NewCleanIngressNginxStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanIngressNginxStepBuilder {
...
func (s *CleanIngressNginxStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("Ingress-Nginx cleanup finished")
	return result, nil
}
