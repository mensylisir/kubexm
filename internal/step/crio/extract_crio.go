...
func NewExtractCrioStepBuilder(ctx runtime.ExecutionContext, instanceName string) *ExtractCrioStepBuilder {
...
func (s *ExtractCrioStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("CRI-O archives extracted successfully")
	return result, nil
}
