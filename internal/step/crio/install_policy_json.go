...
func NewInstallPolicyJsonStepBuilder(ctx runtime.ExecutionContext, instanceName string) *InstallPolicyJsonStepBuilder {
...
func (s *InstallPolicyJsonStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("CRI-O signature policy file installed successfully")
	return result, nil
}
