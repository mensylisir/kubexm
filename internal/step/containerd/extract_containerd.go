...
func NewExtractContainerdStepBuilder(ctx runtime.ExecutionContext, instanceName string) *ExtractContainerdStepBuilder {
...
func (s *ExtractContainerdStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	result.MarkCompleted("all archives extracted successfully")
	return result, nil
}
