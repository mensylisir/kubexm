...
func NewExtractCriCtlStepBuilder(ctx runtime.ExecutionContext, instanceName string) *ExtractCriCtlStepBuilder {
...
func (s *ExtractCriCtlStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
