...
func NewStopKubeProxyStepBuilder(ctx runtime.ExecutionContext, instanceName string) *StopKubeProxyStepBuilder {
	s := &StopKubeProxyStep{
...
func (s *StopKubeProxyStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
