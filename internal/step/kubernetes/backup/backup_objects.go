...
func NewKubernetesBackupObjectsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubernetesBackupObjectsStepBuilder {
...
func (s *KubernetesBackupObjectsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
