...
func NewDisableKubeletStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DisableKubeletStepBuilder {
...
func (s *DisableKubeletStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
