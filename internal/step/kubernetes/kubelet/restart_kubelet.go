...
func NewRestartKubeletStepBuilder(ctx runtime.ExecutionContext, instanceName string) *RestartKubeletStepBuilder {
...
func (s *RestartKubeletStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
