...
func NewEnableKubeletStepBuilder(ctx runtime.ExecutionContext, instanceName string) *EnableKubeletStepBuilder {
	s := &EnableKubeletStep{
...
func (s *EnableKubeletStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
