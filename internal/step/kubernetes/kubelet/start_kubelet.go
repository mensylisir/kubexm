...
func NewStartKubeletStepBuilder(ctx runtime.ExecutionContext, instanceName string) *StartKubeletStepBuilder {
	s := &StartKubeletStep{
...
func (s *StartKubeletStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
