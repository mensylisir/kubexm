...
func NewStopKubeletStepBuilder(ctx runtime.ExecutionContext, instanceName string) *StopKubeletStepBuilder {
	s := &StopKubeletStep{
...
func (s *StopKubeletStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
