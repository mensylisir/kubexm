...
func NewEnableKubeControllerManagerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *EnableKubeControllerManagerStepBuilder {
...
func (s *EnableKubeControllerManagerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
