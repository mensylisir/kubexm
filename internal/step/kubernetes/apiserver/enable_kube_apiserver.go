...
func NewEnableKubeAPIServerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *EnableKubeAPIServerStepBuilder {
...
func (s *EnableKubeAPIServerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
