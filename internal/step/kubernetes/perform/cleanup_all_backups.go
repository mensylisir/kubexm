...
func NewCleanupAllBackupsStepBuilder(ctx runtime.ExecutionContext, instanceName string) *CleanupAllBackupsStepBuilder {
...
func (s *CleanupAllBackupsStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
	...
	if err != nil {
		...
		result.MarkCompleted("failed to connect, skipping")
		return result, nil
	}
