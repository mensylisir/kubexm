...
func NewKubeadmVerifyClusterHealthStepBuilder(ctx runtime.ExecutionContext, instanceName string) *KubeadmVerifyClusterHealthStepBuilder {
...
func (s *KubeadmVerifyClusterHealthStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
...
func (s *KubeadmVerifyClusterHealthStep) checkClusterHealth(ctx runtime.ExecutionContext, conn runner.Connector) error {
