...
func NewDisableKubeSchedulerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DisableKubeSchedulerStepBuilder {
...
func (s *DisableKubeSchedulerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
