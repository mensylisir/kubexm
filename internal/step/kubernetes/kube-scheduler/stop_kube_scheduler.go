...
func NewStopKubeSchedulerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *StopKubeSchedulerStepBuilder {
...
func (s *StopKubeSchedulerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
