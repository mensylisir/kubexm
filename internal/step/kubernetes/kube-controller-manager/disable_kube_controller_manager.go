...
func NewDisableKubeControllerManagerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *DisableKubeControllerManagerStepBuilder {
...
func (s *DisableKubeControllerManagerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
