...
func NewStartKubeControllerManagerStepBuilder(ctx runtime.ExecutionContext, instanceName string) *StartKubeControllerManagerStepBuilder {
...
func (s *StartKubeControllerManagerStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
