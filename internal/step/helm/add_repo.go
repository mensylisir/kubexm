...
func NewAddRepoStepBuilder(ctx runtime.ExecutionContext, instanceName string) *AddRepoStepBuilder {
	s := &AddRepoStep{}
...
func (s *AddRepoStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
