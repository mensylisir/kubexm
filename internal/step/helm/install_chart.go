...
func NewInstallChartStepBuilder(ctx runtime.ExecutionContext, instanceName string) *InstallChartStepBuilder {
	s := &InstallChartStep{}
...
func (s *InstallChartStep) Run(ctx runtime.ExecutionContext) (*types.StepResult, error) {
