...
func NewControlPlaneCleanupModule() module.Module {
	moduleTasks := []task.Task{
		taskKubeadm.NewCleanKubernetesTask(),    // Reset kubeadm and remove all Kubernetes components
		taskKubeadm.NewCleanKubeComponentsTask(), // Stop kubelet, remove kube binaries and service files
	}
