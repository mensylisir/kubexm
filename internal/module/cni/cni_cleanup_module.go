...
import (
	...
	// "github.com/mensylisir/kubexm/internal/apis/kubexms/v1alpha1" // For CNI type check if needed
	// taskCNI "github.com/mensylisir/kubexm/internal/task/cni" // For actual tasks later
)
...
func (m *CNICleanupModule) Plan(ctx runtime.ModuleContext) (*plan.ExecutionFragment, error) {
