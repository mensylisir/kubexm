...
## OVERVIEW
internal/common provides shared constants, types, and defaults used across all layers. All packages can import common (no circular dependency issues).
...
## ANTI-PATTERNS
- **Never add dependencies** - internal/common has NO imports to internal packages
- **Never add functions with logic** - This is for constants/types only
- **Don't hardcode values** in other packages - Add to internal/common instead
