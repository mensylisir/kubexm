...
import (
	...
	// "github.com/mensylisir/kubexm/internal/module/cleanup"
	// "github.com/mensylisir/kubexm/internal/module/kubernetes" // For NodeResetModule potentially
...
func (p *DeleteClusterPipeline) Description() string {
	return "Deletes an existing Kubernetes cluster and cleans up all resources"
}

func (p *DeleteClusterPipeline) GetBase() *pipeline.Base {
	return nil
}
