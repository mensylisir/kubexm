...
- **SSH-only**: `NewConnectorForHost()` rejects "localhost"/"127.0.0.1" and always uses SSH for real hosts
...
## UNIQUE STYLES
- **LocalConnector**: kept for tests/dev only; production paths use SSH exclusively
