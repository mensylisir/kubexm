...
## ANTI-PATTERNS
- **Never create circular imports**: internal/runtime imports internal/runner, internal/runner imports internal/runtime - DO NOT add internal/runner imports to runtime
...
⚠️ **CRITICAL**: `internal/runtime` and `internal/runner` have a circular dependency:
- `internal/runtime` imports `internal/runner` (for `runner.Runner`, `runner.Facts`)
- `internal/runner` imports `internal/runtime` (from `file.go` - likely a mistake)

When adding code to `internal/runtime`, **DO NOT** import `internal/runner` - this will exacerbate the cycle.
